                    ...
                    <div class="col-lg-12">
                        <div class="get-in-touch">
                            <p>Get in Touch With us
                                <a href="tel:(302) 597-7704"><i class="fa fa-phone" aria-hidden="true"></i> (302) 597-7704</a>
                                <a href="mailto:info@oxfordbookus.com"><i class="fa fa-envelope"
                                        aria-hidden="true"></i>
                                    info@oxfordbookus.com</a>
        ...
        <div class="footer-last">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <div class="copyright">
                            <p>Copyright © Oxford Book US 2024. All rights reserved. <a href="javaavoid:;"
                ...
                <div class="row">
                    <div class="col">
                        <p class="disclaimer">
                            ...
                            The services provided by Oxford Book US become clients' property once delivered. Oxford Book US will not hold any ownership rights once your work is successfully accepted by a
                            publishing
                            house.
                        </p>
                    </div>
