			...
			<div class="row">
				<div class="col-12 col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
					<ul>
						...
						<li><a href="tel:(302) 597-7704"><i class="fa fa-phone" aria-hidden="true"></i>(850)
								764-8090</a></li>
						<li><a href="mailto:info@oxfordbookus.com"><i class="fa fa-envelope"
	...
	<div class="head_top">
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<div class="logo">
						<img width="100%" height="100%" alt="The writer tree" class="lazy" src="images/logo.png"
				...
				<div class="col-sm-8">
					<div class="serv-cta-btn inr-tab-btn header-btn cta-tab-btn">
						<a href="tel:(302) 597-7704" class="serv-cta-tel"><i class="fa fa-phone"
								aria-hidden="true"></i>(302) 597-7704</a>
